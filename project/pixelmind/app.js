...
function buildPrompt() {
  ...
  let prompt = 'Create a high-quality image of ' + subject;
  if (env) prompt += ' in ' + env;
  prompt += ', style: ' + style + ', lighting: ' + lighting + ' lighting, mood: ' + mood + ', ' + quality + ', professional quality';
  if (extra) prompt += ', ' + extra;
  prompt += ' --no blur, distortion, low quality';
